...
export const EMPLOYEE_NOT_FOUND = '404033: Employee not found';
...
export const INVALID_ACCESS_TOKEN = '401010: Invalid access token';
export const FAILED_LOGIN = '401000: Failed to log in due to a server error';
export const ACCESS_TOKEN_NOT_FOUND =
  '401011: Access token not found in whitelist';
export const REFRESH_TOKEN_NOT_FOUND =
  '401012: Refresh token not found in whitelist';
export const INVALID_REFRESH_TOKEN = '401013: Invalid refresh token';
export const INSUFFICIENT_PERMISSIONS =
  '401014: Insufficient permissions for this action';
export const BUSINESS_ACCESS_REQUIRED = '401015: Business access required';
...
export const DATABASE_CONNECTION_INVALID =
  '400033: Database connection invalid';
export const INVALID_ACTIVATION_CODE = '400034: Invalid activation code';
export const ACTIVATION_CODE_EXPIRED = '400035: Activation code expired';
export const ACTIVATION_CODE_NOT_CONFIRMED =
  '400036: Activation code not confirmed';
export const INVALID_PASSWORD_RESET_TOKEN =
  '400037: Invalid or expired password reset token';
export const USER_ALREADY_HAS_A_BUSINESS =
  '400038: User already has a business';
